# Binary trees - 0x1D. C - Binary trees

Project done during **Full Stack Software Engineering** at **ALX**. It aims to learn about what is a binary tree advantages, disadvantages and the different traversal methods to go through a binary tree and the different types of binary trees (complete, full, perfect and balanced).

## Visualization File

* [binary_tree_print.c](./binary_tree_print.c): This function is used only for visualize binary
